...
- Categorias da home: no computador, o mouse destaca e o clique leva à página. No celular, o toque só abre a categoria e mostra o botão "Acessar"; a troca automática continua a cada 6s e o botão some quando ela avança. Os números da home (descrições, subtítulo e título do estoque) aparecem em algarismos, a pedido do Luiz.
